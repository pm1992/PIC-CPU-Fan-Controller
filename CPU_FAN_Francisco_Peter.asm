...
Initial
		MOVLF  B'00010001',ADCON0      ;Enable ADCON0, using AN7 for external signal, AN4 for internal POT1
		MOVLF  B'10001101',ADCON2      ;Enable ADCON2
...
ADCON
	...
	rcall T40
	MOVLF B'00000010',ADCON1 ;analog input
	bsf ADCON0,1
...
bra L1000
	...
	MOVLF B'00001110',ADCON1 ;digital output

	MOVLF ADRESL, CLKCYCLE
